# FDV EIMPRO WebApp - Complete Documentation Index
...
The **FDV EIMPRO WebApp** is a comprehensive web application for:
...
| File | Purpose | Lines |
|------|---------|-------|
| `fdv_eimpro_webapp.py` | Main Flask application | 880+ |
| `templates/index.html` | Web interface | 850+ |
| `requirements.txt` | Python dependencies | 5 |
| `launch_eimpro_webapp.ps1` | PowerShell launcher | 30 |
