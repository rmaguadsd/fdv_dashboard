# FDV Chart - Log Parser & Visualizer Web App
...
|----------|---------|---------|
| `FDV_CHART_TMPDIR` | `D:\fdv_chart_tmp` | Temporary directory for uploads/plots |
| `FDV_CHART_SECRET` | `dev-secret-fdv-chart` | Flask session secret key |

### Set Environment Variables (PowerShell)

```powershell
$env:FDV_CHART_TMPDIR = "D:\my_custom_temp"
$env:FDV_CHART_SECRET = "my-secret-key"
python fdv_chart.py
```
...
- 🔑 Change `FDV_CHART_SECRET` for production use
...
Edit `fdv_chart.py` and add new route:
