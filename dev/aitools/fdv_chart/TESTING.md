# FDV Chart - Testing Guide

This guide helps you verify that the FDV Chart is working correctly.
...
```powershell
# Create if needed
New-Item -ItemType Directory -Path "D:\fdv_chart_tmp" -Force -ErrorAction SilentlyContinue
Get-Item "D:\fdv_chart_tmp" | Format-Table
```
...
2. Verify you see:
   - Header: "FDV Chart Log Parser & Visualizer"
   - 6 navigation tabs
