...
```
fdv_chart/
├── 📄 fdv_chart.py                 Main application (880+ lines)
├── 📄 __init__.py                   Package initialization
├── 📄 requirements.txt              Python dependencies
├── 🚀 launch_fdv_chart.ps1         PowerShell launcher
...
- `__init__.py`: Package initialization
- `launch_fdv_chart.ps1`: Convenient launcher script
